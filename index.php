...
<html>
	...
	<aside id="fh5co-hero">
		<div class="flexslider">
			<ul class="slides">
		   	<li style="background-image: url(images/bg-slider.jpg);">
		   	...
		   	<li style="background-image: url(images/bg-login.jpg);">
		   		<div class="overlay-gradient"></div>
		   		<div class="container">
		   			<div class="row">
			   			<div class="col-md-8 col-md-offset-2 text-center slider-text">
		   	...
		   	<li style="background-image: url(images/bg-professor.png);">
		   		<div class="overlay-gradient"></div>
		   		<div class="container">
		   			<div class="row">
			   			<div class="col-md-8 col-md-offset-2 text-center slider-text">
	...
	<div id="fh5co-counter" class="fh5co-counters" style="background-image: url(images/bg-slider-mobile.jpg);" data-stellar-background-ratio="0.5">
		...
		<div class="row">
			<div class="col-md-8 col-md-offset-2 animate-box">
				<div class="date-counter text-center">
					...
					<p><a href="connexion.html" class="btn btn-primary btn-lg btn-reg">Register Now!</a></p>
				</div>
			</div>
		</div>
	</div>
